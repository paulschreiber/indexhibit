...
class Jxs_ndxzbox
{
    ...
    function centered()
    {
        ...
        // we need the base index.php file for this one
            ...
            if ($this->rs['media_title'] != '') {
                $d .= "<div style='width: 250px;'><a href='#' onclick=\"$('#toggle').toggle();\" style='display: block;'>[+]</a><div id='toggle' style='display: none; background: black; padding: 3px 6px 6px 0;'>" . $this->rs['media_caption'] . "\n";
            }
            $d .= "</div></div>\n";
        ...
        } else // photos
        {
            ...
            if ($this->rs['media_title'] != '') {
                $d .= "<div id='dialog-box-text'><a href='#' onclick=\"$('#dialog-toggle').toggle();\" style='display: block;'>[+]</a><div id='dialog-toggle'>" . $this->rs['media_caption'] . "\n";
            }
            $d .= "</div></div>\n";
