    ...
    function picker()
    {
        ...
        if (isset($OBJ)) {
            ...
            if (($OBJ->hook->options['indexhibit_style']['astyle'] == 'bold') || ($OBJ->hook->options['indexhibit_style']['astyle'] == 'italic')) {
                if ($OBJ->hook->options['indexhibit_style']['astyle'] == 'bold') {
                    $OBJ->page->exhibit['dyn_css'][] = "li.active a:link, li a.active, li.active a:hover, li a.active, li.active a:active, li a.active, li.active a:visited, li a.active, li span.active, #index ul.section li.active a:link, #index ul.section li.active a:hover, #index ul.section li.active a:active, #index ul.section li.active a:visited { font-weight: bold; }";
                }
            
                if ($OBJ->hook->options['indexhibit_style']['astyle'] == 'italic') {
                    $OBJ->page->exhibit['dyn_css'][] = "li.active a:link, li a.active, li.active a:hover, li a.active, li.active a:active, li a.active, li.active a:visited, li a.active, li span.active, #index ul.section li.active a:link, #index ul.section li.active a:hover, #index ul.section li.active a:active, #index ul.section li.active a:visited { font-style: italic; }";
                }
            }
        
            if (($OBJ->hook->options['indexhibit_style']['ststyle'] == 'bold') || ($OBJ->hook->options['indexhibit_style']['ststyle'] == 'italic')) {
                if ($OBJ->hook->options['indexhibit_style']['ststyle'] == 'bold') {
                    $OBJ->page->exhibit['dyn_css'][] = "#index ul.section span.section_title, #index ul.section span.section_title a, #index ul.section span.subsection_title, #index ul.section span.subsection_title a { font-weight: bold; }";
                }
            
                if ($OBJ->hook->options['indexhibit_style']['ststyle'] == 'italic') {
                    $OBJ->page->exhibit['dyn_css'][] = "#index ul.section span.section_title, #index ul.section span.section_title a, #index ul.section span.subsection_title, #index ul.section span.subsection_title a { font-style: italic; }";
                }
            }
