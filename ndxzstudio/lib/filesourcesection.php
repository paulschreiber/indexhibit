        ...
        // get subsections order
            ...
            // order by section sub and ord
                if ($rw['section_sub'] != '') {
                    ...
                    $new[$rw['section_id']][$new_subs[$rw['section_sub']]['sub_order']][$top] = $rw;
                } else // standard
                {
                    $new[$rw['section_id']][0][] = $rw;
                }
            }
        }
    ...
    public function getDisplayImages()
    {
        ...
        // get subsections order
            ...
            //print_r($rw); exit;
                ...
                if ($rw['section_sub'] != '') {
                    $top = ($rw['subdir'] == 1) ? 0 : $rw['ord'];
                    $new[$rw['section_id']][$rw['section_sub']][$top] = $rw;
                    //$new[$rw['section_id']][$new_subs[$rw['media_id']]['sub_order']][$top] = $rw;
                } else // standard
                {
                    $new[$rw['section_id']][0][] = $rw;
                }
