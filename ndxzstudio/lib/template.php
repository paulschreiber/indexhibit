...
class Template
{
    ...
    */
    public function tpl_site_menu()
    {
        ...
        if (!is_array($this->tpl_modules())) {
            show_error('no menu created');
        }
    ...
    */
    ...
    {
        if (!isset($this->module_js[$js])) {
            $this->module_js[$js] = $js;
        }
    }
    ...
    */
    ...
    {
        if (!isset($this->module_css[$css])) {
            $this->module_css[$css] = $css;
        }
    }
