...
class Page
{
    ...
    */
    public function theme_css()
    {
        ...
        if (!isset($this->exhibit['theme_css'])) {
            return;
        }
    ...
    */
    public function prototype()
    {
        ...
        if (empty($this->js_prototype_table)) {
            return;
        }
    ...
    */
    public function jquery_onready()
    {
        ...
        if (empty($this->js_jquery_onready_table)) {
            return;
        }
    ...
    */
    public function prototype_onready()
    {
        ...
        if (empty($this->js_prototype_onready_table)) {
            return;
        }
