...
class Media
{
    ...
    */
    ...
    public function regenerate($id = 0, $file = '')
    {
        ...
        if (($this->makethumb == true) && ($this->makesysthumb == true)) {
            $this->make_systhumb();
        }
        
        if ($this->make_sys == true) {
            $this->make_system();
        }
