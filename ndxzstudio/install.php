...
define('PX', '$c[n_appnd]');";
    ...
    function do_the_upgrade()
    {
        ...
        if ($objects_prefs['obj_itop'] != '') {
            $settings['obj_itop'] = str_replace($search, $replace, $objects_prefs['obj_itop']);
        }
        if ($objects_prefs['obj_ibot'] != '') {
            $settings['obj_ibot'] = str_replace($search, $replace, $objects_prefs['obj_ibot']);
        }
